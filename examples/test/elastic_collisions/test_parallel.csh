mpirun -np 2 ../../../optimized/hd.opt collisions.inp > collisions.out
...
if( $RESULT == "PASS" ) then
	set str = "Collision test (in parallel) PASSED."
else
	set str = "Collision test FAILED with a bad energy (in parallel)."
endif
