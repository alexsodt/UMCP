...
//	void nearPointOnBoxedSurface( double *pt, int *f, double *u, double *v, double **M, int mlow, int mhigh, double *distance, double L=-1 ); 
	...
	bool withinBoxedSurface( double *pt, int *f, double *u, double *v, double **M, int mlow, int mhigh, double *distance, double L=-1, int inside_outside=-1, int disable_PBC_z=0); 
