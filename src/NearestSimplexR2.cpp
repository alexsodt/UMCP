...
Check Min_Distance::NearestSimplex()
{
...
//double Min_Distance::near_point_on_triangle( double v1x, double v1y, double v1z,
 ...
 * */
	...
	double d13_23 = d13x*d23x + d13y*d23y + d13z*d23z;
	
	double u = -((-4*(d23x*d23x + d23y*d23y + d23z*d23z)*
        (d13x*v3x + d13y*v3y + d13z*v3z) + 
       4*(d13_23)*
        (d23x*v3x + d23y*v3y + d23z*v3z))/(
     (4*d13_23*d13_23) - 
       4*(d13x*d13x+d13y*d13y+d13z*d13z )*
        (d23x*d23x+d23y*d23y+d23z*d23z)));
...
//	printf("%le %le\n", new_u, u );
	...
	double dp_12 = v1x*v2x+v1y*v2y+v1z*v2z;
	double dp_13 = v1x*v3x+v1y*v3y+v1z*v3z;
	double dp_23 = v2x*v3x+v2y*v3y+v2z*v3z;
	
	double v = (-u*dp_12 + u * dp_13 + u * dp_23  
	+ r3 - u * r3 - dp_23 )/
   (r2 - 2 * dp_23  + r3);
